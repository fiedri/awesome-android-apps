...
|-----|--------|-------------|-------|-------------|-------|
| **[`MoeList`](https://github.com/axiel7/MoeList "link")** | ![healthy](https://img.shields.io/badge/status-healthy-success) | Another unofficial Android MAL(MyAnimeList) client, track your progress in both anime and mangas. See top charts, search, and manage your list. | 652 | ![last commit](https://img.shields.io/github/last-commit/axiel7/MoeList) | [`[playstore]`](https://play.google.com/store/apps/details?id=com.axiel7.moelist "playstore") |